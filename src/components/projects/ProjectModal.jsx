...
export default function ProjectModal({ isOpen, onClose, onSaveProject, editingProject = null }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-start pt-6 pb-6 px-4 bg-slate-950/80 backdrop-blur-sm animate-fade-in overflow-hidden">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-xl w-full shadow-2xl flex flex-col max-h-[calc(100vh-48px)] overflow-hidden">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-3 pr-14 py-2 bg-slate-800 border border-slate-700 rounded-xl text-xs text-white font-mono font-bold focus:outline-none focus:border-emerald-500 transition"
                  min="0"
                  step="1000000"
                />
              ...
              <div className="flex items-center gap-1.5 mt-1.5 overflow-x-auto pb-0.5">
                ...
                {[10_000_000_000, 50_000_000_000, 100_000_000_000, 500_000_000_000].map((val) => (
                  <button
                    ...
                    className="px-2 py-0.5 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 text-[10px] text-emerald-400 font-mono font-semibold transition cursor-pointer"
                  >
              ...
              {/* Readout */}
              {initialTmdtNum > 0 && (
                <div className="mt-1.5 p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-xs font-mono text-emerald-300 space-y-0.5">
